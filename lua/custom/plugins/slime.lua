return {
  ...
  },
  {
    ...
    init = function()
      ...
      vim.keymap.set('n', '<leader><leader>', vim.cmd.SlimeSend, { noremap = true, desc = 'send line to term' })
      vim.keymap.set('n', '<leader>cv', vim.cmd.SlimeConfig, { noremap = true, desc = 'Open slime configuration' })
      vim.keymap.set('x', '<leader>er', '<Plug>SlimeRegionSend', { noremap = true, desc = 'send line to tmux' })
